// MemoryScanner.cpp : Defines the entry point for the application.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MEMORYSCANNER));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MEMORYSCANNER));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground =  (HBRUSH)CreateSolidBrush(RGB(30, 30, 30));
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MEMORYSCANNER);
